...
{% include play.html identifier="vocab-Native-Dialogue" lesson="C1L01" start=4.98 stop=54.26 %}## 1. Countable nouns   *Danh từ đếm được*
...
{% include play.html identifier="vocab-Native-Dialogue" lesson="C1L01" start=59 stop=666 %}## 2. Uncountable nouns   *Danh từ không đếm được*
...
{% include player2.html identifier="vocab-Native-Dialogue" lesson="C1L01" start=90 stop=666 %}## 3. More examples   *Ví dụ thêm*

{% include play.html identifier="vocab-Native-Dialogue" lesson="C1L01" start=95 stop=102 %}### A. What do you choose?   *Bạn chọn gì?*
