...
##### | ed = ed sound for verbs ending with a t or d |
 - {% include play.html identifier="regular" start=113.28 stop=116.28 %} **We visited our parents.**   *Chúng tôi thăm bố mẹ*     
 - {% include play.html identifier="regular" start=116.28 stop=118.28 %} **My sister finally graduated!**     *Chị tôi cuối cùng cũng tốt nghiệp*    
 - {% include play.html identifier="regular" start=118.28 stop=121.28 %} **I visited my old friend from school.**   *tôi thăm bạn học cũ*      
 - {% include play.html identifier="regular" start=121.28 stop=126.28 %} **My husband and I intended to travel to Australia last year**     *Chồng và tôi dự định đi Úc nắm ngoài*    
 - {% include play.html identifier="regular" start=126.28 stop=129.28 %} **Sarah and Michael dated for a week.**     *Sarah và Michael hẹn hò trong một tuần*    
 - {% include play.html identifier="regular" start=129.28 stop=132.78 %} **I attended the event. It bored me.** *Tôi tham gia sự kiện. Nó làm tôi thấy chán*     
 - {% include play.html identifier="regular" start=132.78 stop=135.28 %} **I needed some help last night.** *Hôm qua tôi cần sự giúp đỡ*          
 - {% include play.html identifier="regular" start=135.28 stop=138.28 %} **My dog wanted to go outside.**     *Con chó của tôi muốn ra ngoài*   
 - {% include play.html identifier="regular" start=138.28 stop=142.28 %} **She invited us to her birthday party.**    *Cô ta mời chúng tôi tới bữa tiệc sinh nhật của cô ấy* 

{% include play.html identifier="regular" start=142.28 stop=147.28 %}
##### | ed = d for all other verbs |
 - {% include play.html identifier="regular" start=147.28 stop=150.28 %} **The dog followed me home.**    *Con chó theo tôi về nhà*   
 - {% include play.html identifier="regular" start=150.28 stop=154.58 %} **I cleaned the entire house by myself.**  *Tôi tự lau dọn cả căn nhà*     
 - {% include play.html identifier="regular" start=154.58 stop=158.58 %} **My sister played music until 3 a.m.**     *Em gái tôi bật nhà tới 3h sáng*   
 - {% include play.html identifier="regular" start=158.58 stop=161.58 %} **Her hair smelled really bad.**  *Tóc cô ta có mùi rất ghê*    
 - {% include play.html identifier="regular" start=161.58 stop=164.58 %} **My neighbor moved to Chicago.**     *Hàng xóm tôi chuyển chỗ tới Chicago*   
 - {% include play.html identifier="regular" start=164.58 stop=168.58 %} **I returned my library books in time.** *Tôi trả lại mấy quyển sách thư viện vừa kịp lúc*       
 - {% include play.html identifier="regular" start=168.5 stop=171.28 %} **His aunt raised him.**     *Cô của anh ấy đã nuôi nấng anh*   
 - {% include play.html identifier="regular" start=171.28 stop=175.28 %} **I traveled all across Europe last year.**     *Tôi đi du lịch khắp Châu Âu năm ngoái*   
